# Космическое приложение для Android 🚀

## Описание проекта

Это Android-приложение, посвященное космосу, с интеграцией данных от SpaceX и NASA. В разработке используется современный стек технологий от Google, что обеспечивает высокую производительность и гибкость приложения. На данный момент проект закончен.
...
- **Сетевые запросы**: Ktor client, OkHttp
...
<p align="center">
  <img src="https://github.com/user-attachments/assets/aa456dfb-25a1-44d5-8804-003fd6f3d0f3" alt="Экран оповещений" width="25%"/>
</p>
